...
import kr.ac.dankook.VettDiagnosisServer.mapper.MemberEvent;
import kr.ac.dankook.VettDiagnosisServer.mapper.MemberEventMapper;
import kr.ac.dankook.VettDiagnosisServer.repository.MemberRepository;
...
public class MemberConsumerService {
    ...
    @KafkaListener(groupId = "NaHC_DIAGNOSIS", topics = "USER_MODIFIED")
    ...
    @KafkaListener(groupId = "NaHC_DIAGNOSIS",topics = "USER_CREATED")
    ...
    @KafkaListener(groupId = "NaHC_DIAGNOSIS",topics = "USER_DELETED")

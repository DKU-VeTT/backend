...
import kr.ac.dankook.VettChatServer.mapper.MemberEvent;
import kr.ac.dankook.VettChatServer.mapper.MemberEventMapper;
...
public class MemberConsumerService {
    ...
    @KafkaListener(groupId = "NaHC_CHAT", topics = "USER_MODIFIED")
    ...
    @KafkaListener(groupId = "NaHC_CHAT",topics = "USER_CREATED")
    ...
    @KafkaListener(groupId = "NaHC_CHAT",topics = "USER_DELETED")
